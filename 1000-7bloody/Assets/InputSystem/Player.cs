...
public partial class @Player : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Health+"",
                    ""type"": ""Button"",
                    ""id"": ""287f18bf-7c34-44b6-82bf-fd37df5c7896"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""203c7ef7-b6a7-4d21-9f38-523e12e91389"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""8608632e-3d0c-44c0-b0e8-6b922cd29135"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""5099391e-d877-46bf-acb6-a3d819cb6228"",
                    ""path"": ""<Keyboard>/p"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""PauseBtnPressed"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
        ...
        m_Player_ActionMap_Health = m_Player_ActionMap.FindAction("Health+", throwIfNotFound: true);
        m_Player_ActionMap_PauseBtnPressed = m_Player_ActionMap.FindAction("PauseBtnPressed", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Player_ActionMap_Health;
    private readonly InputAction m_Player_ActionMap_PauseBtnPressed;
    public struct Player_ActionMapActions
    {
        ...
        public InputAction @Health => m_Wrapper.m_Player_ActionMap_Health;
        public InputAction @PauseBtnPressed => m_Wrapper.m_Player_ActionMap_PauseBtnPressed;
        ...
        public void SetCallbacks(IPlayer_ActionMapActions instance)
        {
            if (m_Wrapper.m_Player_ActionMapActionsCallbackInterface != null)
            {
                ...
                @Health.started -= m_Wrapper.m_Player_ActionMapActionsCallbackInterface.OnHealth;
                @Health.performed -= m_Wrapper.m_Player_ActionMapActionsCallbackInterface.OnHealth;
                @Health.canceled -= m_Wrapper.m_Player_ActionMapActionsCallbackInterface.OnHealth;
                @PauseBtnPressed.started -= m_Wrapper.m_Player_ActionMapActionsCallbackInterface.OnPauseBtnPressed;
                @PauseBtnPressed.performed -= m_Wrapper.m_Player_ActionMapActionsCallbackInterface.OnPauseBtnPressed;
                @PauseBtnPressed.canceled -= m_Wrapper.m_Player_ActionMapActionsCallbackInterface.OnPauseBtnPressed;
            }
            ...
            if (instance != null)
            {
                ...
                @PauseBtnPressed.started += instance.OnPauseBtnPressed;
                @PauseBtnPressed.performed += instance.OnPauseBtnPressed;
                @PauseBtnPressed.canceled += instance.OnPauseBtnPressed;
            }
        }
    }
    ...
    public interface IPlayer_ActionMapActions
    {
        ...
        void OnPauseBtnPressed(InputAction.CallbackContext context);
    }
}
